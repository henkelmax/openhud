...
public class ClientConfig {
    ...
    public ModConfigSpec.BooleanValue renderCenterIndicator;
    ...
    public ClientConfig(ModConfigSpec.Builder builder) {
        ...
        renderCenterIndicator = builder.comment("If an indicator should be rendered at the center of the HUD").define("render_center_indicator", false);
